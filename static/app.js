document.addEventListener("DOMContentLoaded", () => {
    ...
    const tabMeta = {
        ...
        "skill-mesh": { title: "AI Skill-Mesh", sub: "Cross-reference your stack with a job description for a 48-hour upskilling plan" },
        "rejection-rehab": { title: "Rejection Rehab", sub: "Analyze rejection emails to remove emotional sting and get a pivot strategy" },
        "timezone-calc": { title: "Time-Zone Calc", sub: "Find the perfect sending window for international recruiters" },
        "referral-tracker": { title: "Referral Tracker", sub: "Minimalist CRM to log network nudges and follow-ups" },
        "gd-generator": { title: "GD Phrases", sub: "Instantly build structured talking points for Group Discussion rounds" },
        "thank-you": { title: "Thank-You Sculptor", sub: "Generate non-robotic post-interview thank you notes" },
        "cert-verifier": { title: "Cert Parser", sub: "Extract core skills from course syllabi for high-impact CV bullets" },
        "project-scaler": { title: "Project Scaler", sub: "Enhance basic college projects with enterprise architecture terminology" },
        "reverse-interview": { title: "Reverse Interview", sub: "Generate sharp, tailored closing questions to ask your interviewer" },
        "acronym-decoder": { title: "Jargon Decoder", sub: "Instantly simplify System Design acronyms and architectural jargon" },
        "hackathon-pitch": { title: "Hackathon Pitch", sub: "Condense a 24-hr sprint into a punchy 30-sec recruiter narrative" },
        "takehome-blueprint": { title: "Take-Home Planner", sub: "Break down multi-day coding assignments into 24-hour milestones" },
        "aptitude-vault": { title: "Aptitude Vault", sub: "High-frequency math tricks and memory mnemonics for rapid revision" },
        "company-intel": { title: "Company Intel", sub: "Crowdsourced interview loops, culture highlights, and engineering quirks" },
        "soft-skill-star": { title: "Soft Skill STAR", sub: "Convert messy anecdotes into polished STAR behavioral narratives" },
        "notice-period": { title: "Notice Period Calc", sub: "Calculate transition timelines, resignation dates, and handovers instantly" },
